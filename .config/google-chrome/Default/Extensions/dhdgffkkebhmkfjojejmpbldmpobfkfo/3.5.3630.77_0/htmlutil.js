...
var t=Registry.get("helper");var n=function(w,x,z,B,E,y,G){var A=h("div","clickable enabler",x,z,B,"wrap",true);
var C=e("image",x,z,B,true);var D;C.setAttribute("src",w);
...
return A};var i=function(z,w,C,B){var A=h("image","icon16",w,C,t.filter(B,/[a-zA-Z0-9]/g));
...
y();if(B){A.title=B}A.alt=" ?";return A};var u=function(C,z,D,w,B,y){var A=h("image","icon16",z,D,w,true);
...
var z=e("span",y.name,y.id,"validation",true);if(x.image){z.setAttribute("style","background-image: url("+x.image+"); background-size: 16px auto; height: 20px; width: 20px; background-repeat:no-repeat; display: inline-block; margin-left: 10px; vertical-align: middle;")
...
}else{z=(z?z+" ":"")+w}y.setAttribute("class",z)};Registry.register("htmlutil","3630.77",{addClass:j,toggleClass:q,createValidation:k,createImageText:n,createImage:u,createFavicon:i,createFileInput:g,createTextarea:c,createInput:r,createPassword:o,createCheckbox:m,createDropDown:b,createScriptStartDropDown:v,createImageButton:s,createButton:p,createPosition:l,createSearchBox:a})
})();