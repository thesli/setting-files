...
(function(){var e=null;var i=null;var a=null;var d="manifest.json";
var c="script.js";var b=function(k){try{var l=new XMLHttpRequest();
l.open("GET",k,false);l.send(null);return l.responseText||null
}catch(j){}return};var f=function(m,j,l,k){if(k===undefined){k=d
}return[i,m,"/",j,"_",l,"/",k].join("")};var g=function(o,j){for(var m,k=0;
k<4;k++){m=f(o,j,k);try{var n=b(m);if(n&&JSON.parse(n)){return k
}}catch(l){}}console.log("import: unable to load ",i);
...
return}catch(l){}if(j){window.setTimeout(j,1)}}};Registry.register("native","3630.77",{create:function(j){e=j;
return h}})})();