...
var a={mkCompat:function(d,c,e){if(c){if(c.options.compat_wrappedjsobject||e){d=a.unWrappedJsObjectify(d)
}if(c.options.compat_metadata||e){d=a.unMetaDataify(d)
...
}};Registry.register("compat","3630.77",a)
})();