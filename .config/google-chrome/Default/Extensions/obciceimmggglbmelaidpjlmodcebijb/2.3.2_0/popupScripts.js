...
BH.Templates.tagged_sites = "<ul class='visits highlightable editable'>  {{#sites}}    <li class='visit tagged' draggable='true' data-id='{{url}}'>      {{^readOnly}}        <div class='drag_handle'>          <div class='line'></div>          <div class='line'></div>          <div class='line'></div>          <div class='line'></div>          <div class='line'></div>        </div>      {{/readOnly}}      <a href='{{url}}' class='site'>        <dl class='description' style='background-image: url(chrome://favicon/{{url}})'>          <dt>            <div class='active_tags'></div>            {{title}}          </dt>          <dd>{{url}}</dd>        </dl>      </a>      {{^readOnly}}        <a class='delete' href='{{url}}' title=''></a>      {{/readOnly}}    </li>  {{/sites}}</ul>{{^sites}}  <p class='no_results'>{{i18n_no_tagged_sites_found}}</p>{{/sites}}";
...
(function() {
  ...
  BH.Models.Site = (function(_super) {
    ...
    Site.prototype.initialize = function(attrs, options) {
      if (attrs == null) {
        attrs = {};
      }
      if (options == null) {
      ...
      return this.chromeAPI = options.chrome;
    };
