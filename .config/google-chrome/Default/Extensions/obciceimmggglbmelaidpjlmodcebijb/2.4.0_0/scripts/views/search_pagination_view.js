...
(function() {
  ...
  BH.Views.SearchPaginationView = (function(_super) {
    ...
    SearchPaginationView.prototype.onVisitRemove = function() {
      var copy;
      if (this.collection.length % 100 === 0) {
        return this.render();
      } else {
        copy = this.t('number_of_visits', [this.collection.length]);
        return this.$('.number_of_visits').text(copy);
      }
    };
    ...
    SearchPaginationView.prototype.getI18nValues = function() {
      var properties;
      properties = [];
      properties['i18n_number_of_visits'] = this.t('number_of_visits', [this.collection.length]);
      return properties;
    };
