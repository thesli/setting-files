...
function health_check() {
  ...
  ajax( "http://www.imgclck.com/health_check.js?ts=" + (+new Date),
...
function onRequest(request, sender, sendResponse) {
  if (request == "get-impressions") {
    ...
    var not_blacklisted = !user_blacklist[domain] 
    ...
    if (response) {
      var delta = getRandomInt(stored.random_low * 1000, stored.random_high * 1000);
