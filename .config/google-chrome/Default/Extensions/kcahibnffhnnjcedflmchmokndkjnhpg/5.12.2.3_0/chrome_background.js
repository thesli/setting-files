var ChromeBackgroundPage = BackgroundPage.extend({
    ...
    init: function() {
        ...
        // Create chromebar-specific elements
        this.addScript("contests.js", function() {
            Contests.init(window, Strings.get("CONTESTS_URL"));
        ...
        chrome.tabs.onUpdated.addListener(function(tabid, changeInfo, tab) {
                ...
                self.updateActiveUrls();
                if (changeInfo.url)
                    Contests.checkShowNotification(changeInfo.url);
        });
