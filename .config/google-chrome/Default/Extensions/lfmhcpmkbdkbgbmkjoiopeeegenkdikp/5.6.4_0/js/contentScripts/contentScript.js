(function(){
	...
	function displayRateMessage( type ) {
		...
		else if (type == "vkontakte")
		{
			...
			var first_line = "Сделай свой вКонтакте уникальным!";
			var second_line = "";
			var third_line = null;
			var button_title = "Попробовать";
			var url = "https://chrome.google.com/webstore/detail/vk-themes-pro/ipjmkmdjhlokhmjljlnfcciaibbgfeoh?hl=en-US";
		}
