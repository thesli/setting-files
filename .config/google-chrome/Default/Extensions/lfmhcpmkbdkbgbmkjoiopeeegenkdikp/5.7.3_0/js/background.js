...
chrome.extension.onMessage.addListener(function( message, sender, callback ){
		...
		else if( message && message.action == "SettingOptions")	{
			display_settings();  
		}
...
//console.log(extensions[i].name);			
				...
				else if ( extensions[i].name == "VK Themes Pro" )  {
					fvdSingleDownloader.Prefs.set( "rate.display_reklama_vkontakte1", false );
				}	
				else if ( extensions[i].name == "Hey Pets for VK" )  {
					fvdSingleDownloader.Prefs.set( "rate.display_reklama_vkontakte2", false );
				}	
            }
        }
