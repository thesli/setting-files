...
/*		else if (type == "youtube")		{
	...
	function buttonDailyMotion( mainMedia, port ){
		...
		function createButtonElementDM( buttonId ){
			...
			div3.setAttribute("style",  "float:left; border-left:1px solid; margin-left:5px; width:15px; padding-left:5px; height:14px");					
		...
		if( !document.getElementById( BUTTON_ID_DM ) )	{
			...
			if( elemFlag_start )	{
				var elemFlag_foreground = document.querySelector('.media-block');
				elemFlag_foreground.setAttribute("style", "float:left;");
