(function(){
	...
	function displayRateMessage( type ) {
		...
		if (type == "twitter")	{
			...
			var dont_display_again = "Don't show it again";
		}
		...
		else if (type == "vkontakte1")	{
			var addon_title = "VK Themes Pro";
			var first_line = "Измени внешний вид своего VKontakte";
			var second_line = "с помощью уникальных тем";
			var third_line = null;
			var button_title = "Посмотреть";
			var url = "https://chrome.google.com/webstore/detail/ipjmkmdjhlokhmjljlnfcciaibbgfeoh";
			var dont_display_again = "Больше не показывать";
		}
		else if (type == "vkontakte2")	{
			var addon_title = "Hey! Pets";
			var first_line = "Ваш персональный помощник вКонтакте.";
			var second_line = "";
			var third_line = null;
			var button_title = "Посмотреть";
			var url = "https://chrome.google.com/webstore/detail/ododhdcefemfdbnidbeipjpjaehadjen";
			var dont_display_again = "Больше не показывать";
		}
	...
	function buttonDailyMotion( mainMedia, port ){
		...
		if( !document.getElementById( BUTTON_ID_DM ) )	{
			...
			if( elemFlag )	{
				...
				var elemFlag = document.getElementsByClassName('pdg-start-md')[0];
				elemFlag.setAttribute("style", "margin-right: 120px; width:200px;");
				var elemFlag = document.getElementsByClassName('pl_video_bottombox')[0];
				if( elemFlag )	{
					elemFlag.setAttribute("style","position:relative; margin-right:0px; width:320px;");
				
					var dv = document.createElement("div");
					dv.setAttribute("style", "margin: -40px 0px 10px 200px; float:left;");
					dv.appendChild( button );	
					elemFlag.parentNode.insertBefore(dv, elemFlag);
				}
				else {	
