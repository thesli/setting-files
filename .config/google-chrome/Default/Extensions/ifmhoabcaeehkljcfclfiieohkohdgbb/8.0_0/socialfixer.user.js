...
var undef;
var config_url = "http://socialfixer.com/config8.json?type="+SCRIPT_TYPE+"&version="+version;
					...
					try {
						...
						this.load = function(callback) {
							...
							getValue(this.userid+'/prefs',{},function(storedPrefs,errorMsg) {
								if (storedPrefs===null) {
									add_error("Your stored preferences could not be read because they have become corrupt. Social Fixer is running with default options and you won't be able to save anything. For more details, click this message.",errorMsg,null,function(){window.open('http://SocialFixer.com/corruptprefs');},{"title":"Click for more information"});
									self.prefs = {
...
*/
						...
						function fixStory(o,isPageOrProfile,isGroupWall) {
							...
							if (display_control_panel) {
								var cp = $('better_fb_cp');
								if (cp==null) { 
									var hs = QS(document,'#home_stream,#profile_stream_container,#profile_minifeed,#pagelet_group,.fbTimelineComposerCapsule,#stream_pagelet div[id*="main_stream"]');
									if (hs!=null) {
											...
											setTimeout(function() {
												...
												if (pagelet) {
													append(pagelet, minimessage(
														'Why is Friend Tracker stuck on "Loading"?<br>&nbsp;&nbsp;&nbsp;<a style="text-decoration:underline;" href="http://socialfixer.com/faq.html#3rdpartycookies" target="_blank">See the FAQ!</a>'
														,null
												...
												if (friend_list && friend_list.length>5) {
													...
													if (h) {
														...
														if (options.get('friend_tracker_show_note')) {
															append(pagelet, minimessage(
																'Why are these friends listed here?<br>&nbsp;&nbsp;&nbsp;<a style="text-decoration:underline;" href="http://SocialFixer.com/faq.html#friendtracker" target="_blank">Learn More!</a>'
																,function() {
										...
										for (var i=0;i<message_list.length; i++) {
											...
											if (m && m.id && m.id>0 && m.id>last_message_id) {
												...
												click(QS(c,'.bfb_button_close'),function() {
													options.set('last_message_check',time(),false);
													options.set('last_message_id',m.id,false);
													options.set('show_message',false,false);
													options.save();
													setTimeout(function(){removeChild(c);},200);
												},false);
...
//													ta.value = ta_value+prefix+text;
						...
						make_hideable('#navHome','Home Shortcut');
...
//							});
						...
						(function() {
							onSelectorLoad('#medley_header_friends',function(o) {
								...
								var a = el('a','uiButton uiButtonOverlay uiButtonLarge',{id:'sfx_friends_sort_by_name'},{click:function() {
								...
								},'<span class="uiButtonText">Sort By Name</span>');
