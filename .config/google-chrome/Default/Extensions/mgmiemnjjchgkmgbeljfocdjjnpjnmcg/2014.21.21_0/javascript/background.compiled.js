(function() {
  var DEFAULTS, TILE_MAX_HEIGHT, TILE_MAX_WIDTH, TILE_MIN_HEIGHT, TILE_MIN_WIDTH, buildWidgetObject, getAllTabs, getAllTabs_callback, onMessage, onMessageExternal, onRemoved, removeWidgetInstances, sayHelloToPotentialWidgets, showAppsUI;
