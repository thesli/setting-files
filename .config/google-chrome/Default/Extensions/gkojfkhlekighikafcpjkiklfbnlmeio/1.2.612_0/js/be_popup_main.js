...
function message_cb()
{
	...
	return $checkbox.addClass('enabled');
...
function create_ui()
{
    ...
    window.tt = new be_ui_obj.tooltip({className:'l_ui_obj_tooltip',
	$parent: $s});
    window.tt.on('show', function(){ return ver_info(window.tt); });
    ...
    dev_info();
    E.listen_to(E.be_bg_main, 'change:enabled change:exe.is_svc', message_cb);
