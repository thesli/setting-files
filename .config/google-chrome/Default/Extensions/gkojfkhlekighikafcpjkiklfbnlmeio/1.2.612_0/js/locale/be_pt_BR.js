...
var E = {
    ...
    "BN": {message: "Brunei"},
    "ZM": {message: "Zâmbia"},
    "app_desc": {message: "Acesse a TUDO na internet! Vá a um site bloqueado > clique no ícone Hola > mude a bandeira do país > APROVEITE!"},
    ...
    "Access any site from any country, free": {message: "Acesse a qualquer site a partir de qualquer país!"},
    ...
    "KH": {message: "Camboja"},
    "TG": {message: "Togo"},
    "Hola cannot work properly because another extension is controlling your proxy settings. Please disable other extensions that you think might control your proxy settings in <a>extensions</a> (such as ad-blockers, other VPN services, etc.).": {message: "Hola está funcionando porque outra extensão está controlando as configurações de proxy. Por favor, desative outras extenções que você acha que podem controlar as configurações de proxy em <a>extensões</a> (como bloqueadores de anúncios, outros serviços de VPN, etc)."},
    "BB": {message: "Barbados"},
    "JE": {message: "Jersey"},
