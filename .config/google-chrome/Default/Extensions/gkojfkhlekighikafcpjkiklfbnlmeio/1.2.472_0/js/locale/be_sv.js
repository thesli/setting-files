...
var E = {
    ...
    "More countries": {message: "Mer länder"},
    "AM": {message: "Armenien"},
    "SR": {message: "Surinam"},
    ...
    "not working?": {message: "Fungerar inte?"},
    "TH": {message: "Thailand"},
    "Author:": {message: "Ägare:"},
    "CC": {message: "Kokosöarna"},
    "NC": {message: "Nya Kaledonien"},
    "Get the Fastest Servers": {message: "Få dom snabbaste servrarna"},
    "TO": {message: "Tonga"},
    "SE": {message: "Sverige"},
    ...
    "CM": {message: "Kamerun"},
    "The free version of Hola needs to be re-enabled every 4 hours and is sponsored by ads.": {message: "Gratisversionen av Hola behöver startas var fjärde timme och är reklambaserad."},
    "Hola": {message: "Hola"},
    "NP": {message: "Nepal"},
    "PL": {message: "Polen"},
    "GA": {message: "Gabon"},
    ...
    "CU": {message: "Kuba"},
    "CL": {message: "Chile"},
    "Get 24/7 Unblocking": {message: "Få 24/7 Unblocking"},
    "ML": {message: "Mali"},
    "ET": {message: "Etiopien"},
    "IS": {message: "Island"},
