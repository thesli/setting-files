...
var E = {
    ...
    "CM": {message: "Cameroun"},
    "The free version of Hola needs to be re-enabled every 4 hours and is sponsored by ads.": {message: "La version gratuite de Hola doit être réactivée toutes les 4 heures et est soutenue par des pubs."},
    "Hola": {message: "Hola"},
    "NP": {message: "Népal"},
    "PL": {message: "Pologne"},
    "GA": {message: "Gabon"},
    ...
    "Verify you have Internet": {message: "Vérifiez que vous disposez d'Internet"},
    "LA": {message: "Laos"},
