...
function message_cb()
{
	...
	$checkbox.hide();
        ...
        $checkbox.show();
    if (E.be_bg_main.get('enabled') || E.be_bg_main.get('svc.running'))
...
{
    return (E.be_bg_main.get('svc.running') || E.be_bg_main.get('enabled')) &&
...
function svc_running_cb()
{
    ...
    delete E.ui_vpn;
    delete E.ui_accel;
    if (!E.be_bg_main.get('exe.connected') && !E.be_bg_main.get('svc.running'))
	return;
...
function create_ui()
{
	...
	message_cb);
    E.listen_to(E.be_bg_main, 'change:svc.running change:exe.connected',
        svc_running_cb);
