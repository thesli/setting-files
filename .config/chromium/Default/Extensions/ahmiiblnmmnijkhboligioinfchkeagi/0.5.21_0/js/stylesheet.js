...
chrome.extension.sendRequest({elements: 'o'}, function(response) {
	var css = ".sidebarMode #globalContainer { left: 0 !important; }\n";
	...
	// THEME
		...
		if (response.o.accent) {
			...
			css += "#pageLogo > a, #pageLogo > a:hover, .fbJewel > a, #jewelContainer > div > div > a { background-image: url( " + toolbar + " ) !important; background-color: transparent !important; background-position: 0 0; }\n";
			css += "#requestsWrapper:not(.openToggler) a, #fbRequestsJewel:not(.openToggler) a {background-position: 0 -63px !important;}\n";
			css += "#mailWrapper:not(.openToggler) a, #fbMessagesJewel:not(.openToggler) a {background-position: -50px -96px !important;}\n";
			css += "#notificationsWrapper:not(.openToggler) a, #fbNotificationsJewel:not(.openToggler) a {background-position:-25px -96px !important;}\n";
			css += "#pageNav a:hover, #pageLogo > a:hover, .fbJewel:not(.openToggler) > a:hover { background-color: rgba(255,255,255,.15) !important; }\n";
			...
			css += "#jewelCase .fbJewelHighlightItem li a:hover,#jewelCase .fbJewelHighlightItem li a:active,#jewelCase .fbJewelHighlightItem li a:focus, #navAccount ul a:hover, #navAccount ul .logoutButton input:hover { background: " + lighten(response.o.accentCLR, 0, .65) + " !important; background-color: " + lighten(response.o.accentCLR, 0, .65) + " !important; }\n";
			css += "#pageNav > li > a { color: #fff; }\n";
			css += ".uiHeaderSection, .uiSideHeader, #jewelCase .fbJewelHighlightItem li a:hover,#jewelCase .fbJewelHighlightItem li a:active,#jewelCase .fbJewelHighlightItem li a:focus, #navAccount ul a:hover, #navAccount ul .logoutButton input:hover { border-color: " + lighten(response.o.accentCLR, 0, .15) + " !important; }\n";
